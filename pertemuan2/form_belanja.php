        ...
        <div class="container px-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value ="topi" name="produk" id="topi" type="radio" class="custom-control- " required>
                        <label for="topi" class="custom-control-label">Topi</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value ="jam tangan" name="produk"  id="jam tangan" type="radio" class="custom-control-input" required>
